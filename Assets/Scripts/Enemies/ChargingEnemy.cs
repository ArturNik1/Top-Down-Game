...
public class ChargingEnemy : Enemy
{
    ...
    public override void Move()
    {
        ...
        if (state == ChargingEnemyState.Walking) {
            ...
            if (spriteRenderer2.color.g <= 125/255f) {
                ...
                // green 220 to 120
                float newGreen = Mathf.MoveTowards(spriteRenderer2.color.g, 120/255f, 0.2f * Time.deltaTime);
                spriteRenderer2.color = new Color(spriteRenderer2.color.r, newGreen, spriteRenderer2.color.b);
            }
        }
            ...
            if (spriteRenderer2.color.g >= 215/255f) {
                state = ChargingEnemyState.Walking;
            }
            else {
                // change color and do not move
                float newGreen = Mathf.MoveTowards(spriteRenderer2.color.g, 220 / 255f, 0.2f * Time.deltaTime);
                spriteRenderer2.color = new Color(spriteRenderer2.color.r, newGreen, spriteRenderer2.color.b);
            }
        }
    }
